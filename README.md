...
## v26 software, backend reliability and AI automation update

- Added Reliable Lead Webhook Demo with verified runtime evidence and 7 passing pytest scenarios.
- Added Product Photo Pipeline V1 as a private AI/computer-vision orchestration case study with a portfolio-safe synthetic review-grid generated by the project's own utilities.
